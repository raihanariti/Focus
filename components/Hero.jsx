...
const Hero = () => {
  ...
  return (
    <section className="h-screen xl:h-[1608px] overflow-x-clip relative">
        <Header/>
      <div className="container mx-auto h-full flex items-center xl:items-start">
        {/* text */}
        <motion.div
          className="flex flex-col justify-center items-center gap-6 text-center fixed
          left-0 right-0 mt-24 xl:mt-[160px]"
          style={{
            opacity: textOpacity,
            scale: textScale,
            display: textDisplay,
        ...
        >
          <h1 className="text-[68px] font-bold tracking-[-0.5px] leading-none max-w-[800px] xl:max-w-max">
            Boost Your Productivity Instantly
          </h1>
          <p className="max-w-[688px] text-[26px] text-white/80 font-light px-8 xl:px-0 mb-2">
        ...
        {/* img */}
        <motion.div
          className="hidden xl:flex w-full max-w-[968px] mx-auto h-[520px] bg-no-repeat sticky left-0 right-0"
          style={{
